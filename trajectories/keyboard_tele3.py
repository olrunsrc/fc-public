...
class KeyboardTeleop(object):
    ...
    ARM_BINDINGS = OrderedDict([
        ('q', {'joint_index': 0, 'side': 'left', 'min': -3.0, 'max': 3.0}),
        ('w', {'joint_index': 1, 'side': 'left', 'min': -3.0, 'max': 3.0,
               'invert': True}),
        ('e', {'joint_index': 2, 'side': 'left', 'min': -3.0, 'max': 3.0}),
        ('r', {'joint_index': 3, 'side': 'left', 'min': -2.0, 'max': 0.1,
               'invert': True}),
        ...
        ('u', {'joint_index': 0, 'side': 'right', 'min': -3.0, 'max': 3.0}),
        ('i', {'joint_index': 1, 'side': 'right', 'min': -3.0, 'max': 3.0}),
        ('o', {'joint_index': 2, 'side': 'right', 'min': -3.0, 'max': 3.0}),
        ('p', {'joint_index': 3, 'side': 'right', 'min': -0.1, 'max': 2.0}),
...
#        ('h', {'joint_index': 'reset'}),
    ...
    def __init__(self):
        ...
        bindings = [self.ARM_BINDINGS, self.HEAD_BINDINGS, self.NECK_BINDINGS, self.CHEST_BINDINGS]
        keys = set([])
    ...
    def print_usage(self):
        ...
        msg_args += [
            get_bound_char(self.CHEST_BINDINGS, x)
            for x in self.CHEST_BINDINGS.keys()[0:3]]
        # chest - reset
        msg_args.append(' or '.join([
            self.CHEST_BINDINGS.keys()[3], self.CHEST_BINDINGS.keys()[3].upper()]))
...
if __name__ == '__main__':
    rospy.init_node('keyboard_teleop3')
