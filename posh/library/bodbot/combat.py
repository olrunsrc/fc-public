...
class Combat(Behaviour):
    def __init__(self, agent):
        Behaviour.__init__(self, agent,
                           ("shoot_enemy_carrying_our_flag",
                            "run_to_enemy_carrying_our_flag",
                            "face_attacker", "set_attacker", "shoot_attacker"),
                           ("see_enemy_with_our_flag",
                            "our_flag_on_ground", "enemy_flag_on_ground",
                            "incoming_projectile",
                            "taken_damage_from_specific_player",
                            "taken_damage", "is_responding_to_attack"))
